...
import com.createbyte.lootlevel.databinding.ItemSummaryRowBinding
import com.createbyte.lootlevel.databinding.SheetRedeemBinding
...
class RedeemSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun getTheme(): Int = R.style.Theme_LootLevel_BottomSheet
