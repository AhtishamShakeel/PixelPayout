...
object AdHold {
    ...
    /**
     * True from the start of a hold until the player is released, so a second
     * placement firing meanwhile (a tab switch behind a closing popup, say)
     * can't queue another ad on top.
     */
