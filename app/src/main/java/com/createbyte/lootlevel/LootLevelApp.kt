...
import com.createbyte.lootlevel.utils.InterstitialAdManager
import com.createbyte.lootlevel.utils.UnityAdsNetwork
import com.google.android.gms.ads.MobileAds
import com.google.firebase.FirebaseApp

class LootLevelApp : Application() {
    override fun onCreate() {
        super.onCreate()

        FirebaseApp.initializeApp(this)
        Log.d("LootLevelApp", "Firebase initialized")
