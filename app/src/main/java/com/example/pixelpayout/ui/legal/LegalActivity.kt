package com.example.pixelpayout.ui.legal
 ...
 * one. The "PixelPayoutApp" user-agent marker tells the page to drop its own
...
class LegalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.legalWeb.apply {
            ...
            settings.userAgentString = settings.userAgentString + " PixelPayoutApp"
