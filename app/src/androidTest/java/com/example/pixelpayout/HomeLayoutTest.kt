...
import com.pixelpayout.databinding.LayoutCustomToolbarBinding
import com.example.pixelpayout.ui.main.PixelBottomNav
import java.io.File
            ...
            for ((widthDp, scale) in listOf(390 to 1f, 320 to 1f, 390 to 1.5f, 320 to 1.5f)) {
                for (claimable in listOf(false, true)) {
                    ...
                    val context = ContextThemeWrapper(
                        instrumentation.targetContext.createConfigurationContext(config), R.style.Theme_PixelPayout)
